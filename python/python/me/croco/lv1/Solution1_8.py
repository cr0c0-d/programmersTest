...
def solution(cards1, cards2, goal) :
    # 카드 사용시 순서를 지켜야함 => 스택/큐
    # goal을 순회해서 각 단어를 사용할 수 있는지 여부를 확인
    cards1.reverse()
    cards2.reverse()
    ...
    # reverse()를 사용하지 않으려면 거꾸로 순회하기
    # for index in range(len(goal)-1, -1, -1) :
    #     if cards1 and cards1[-1] == goal[index] :
    #         cards1.pop()
    #     elif cards2 and cards2[-1] == goal[index] :
    #         cards2.pop()
    #     else :
    #         return "No"
